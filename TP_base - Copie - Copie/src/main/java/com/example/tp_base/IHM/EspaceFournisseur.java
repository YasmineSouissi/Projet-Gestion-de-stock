...
public class EspaceFournisseur extends GridPane {
    ...
    private void createContent() {
        ...
        menu.getChildren().addAll( demande,chat, profil, deconexion);
        ...
        borderPane.setCenter(new DemandesF(user));
        ...
        for (Button button : Arrays.asList( demande, profil, chat,deconexion)) {
